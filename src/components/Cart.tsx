          ...
          <div className="ct-header">
            ...
            <div className="ct-header-text">
              ...
              <div className="ct-header-meta">
                <span className="ct-header-tag">{cartItems.length} {cartItems.length === 1 ? "Item" : "Items"}</span>
                <span className="ct-header-divider">•</span>
                <span className="ct-header-price">₹{cartTotal.toLocaleString()}</span>
              </div>
            </div>
            <button className="ct-clear-top" onClick={handleClearClick} title="Clear Cart">
